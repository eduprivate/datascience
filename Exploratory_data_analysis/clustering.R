...
#Prettier dendrograms Prettier dendrograms
...
# Patterns in rows and columns Patterns in rows and columns
...
# Components of the SVD - Components of the SVD - u and and v
...
# What if we add a second pattern? What if we add a second pattern?
set.seed(678910)
for (i in 1:40) {
  # flip a coin
...
# Face example - plot approximations Face example - plot approximations
