...
## Study the impact of Weather Events on Public Health and Economy in the United States
...
```{r}
setwd("/home/cadu/Desktop/Coursera/Reproducible_Research/week3")
#data in different directory to send to git
if (!"stormData.csv.bz2" %in% dir("/home/cadu/Desktop/Coursera/Reproducible_Research/week3")) {
    download.file("http://d396qusza40orc.cloudfront.net/repdata%2Fdata%2FStormData.csv.bz2", destfile = "/home/cadu/Desktop/Coursera/Reproducible_Research/week3/stormData.csv.bz2")
